package com.couree.luckycat.glacier.common;
...
public class Loads {
     ...
     * @param filename file to load. The extension of the file should be ".properties". Notice that this
     *                 argument can be a relative path, the root of which is "/src/main/resources" (depends on
