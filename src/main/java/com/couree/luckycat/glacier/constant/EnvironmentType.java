package com.couree.luckycat.glacier.constant;

/**
 * Development test Environment types.
 * @author James Chan
 * @see <a href="https://www.unitrends.com/blog/development-test-environments">Development Test
 * Envrionment</a>
 */
public enum EnvironmentType {
    /**
     * Environment where application development tasks, such as designing, programming debugging, etc. take
     * place
     */
    DEVELOPMENT,
